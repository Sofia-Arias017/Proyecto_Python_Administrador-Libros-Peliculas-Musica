...
def añadir_elemento():
    while True:
        ...
        print("=" * 43)
        tipo = entrada_usuario("Selecciona una opción (1-4): ")
        ...
        autor_director_artista = entrada_usuario(f"{'Autor' if categoria == 'Libro' else 'Director' if categoria == 'Película' else 'Artista'}: ")
